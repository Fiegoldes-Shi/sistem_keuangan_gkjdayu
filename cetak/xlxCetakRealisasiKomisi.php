...
if (isset($_SESSION["komisi"]) || isset($_SESSION["bidang"])) {
    ...
    $title2 =
        '<h3 style="text-align: center;">LAPORAN REALISASI  ' .
        strtoupper($bidangKomisi) .
        "</h3>";
    ...
    $title1 = "<h2></h2>";
    $allshowdata2 =
        $title1 . $tabelheader . $tabelcaption . $dataall . $tabelfooter;
    ...
    $title1 = '<h2 style="text-align: center;">GEREJA KRISTEN JAWA DAYU</h2>';
    $title2 =
        '<h3 style="text-align: center;">REKAPITULASI REALISASI KOMISI</h3>';
    $title3 = '<h3 style="text-align: center;">' . $laporan . "</h2>";
    $titleLaporan = $title1 . $title2 . $title3;

    $allshowdata =
        $titleLaporan . $tabelheader . $tabelcaption . $dataall . $tabelfooter;
