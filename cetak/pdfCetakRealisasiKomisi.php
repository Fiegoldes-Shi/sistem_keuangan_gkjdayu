...
if (isset($_SESSION["bulan"])) {
    ...
    $title =
        "Rekapitulasi_Realisasi_Komisi_" .
        $nama_bulan[$bulan] .
        "_" .
        $tahun_aktif;
} else {
...
if (isset($_SESSION["komisi"]) || isset($_SESSION["bidang"])) {
    if (isset($_SESSION["komisi"])) {
        $sql_penerimaan =
            "SELECT * from v_realisasikomisi WHERE jenis COLLATE utf8mb4_general_ci='Realisasi Penerimaan'  AND id_komisi =" .
            $id_komisi .
            "";
        $sql_pengeluaran =
            "SELECT * from v_realisasikomisi WHERE jenis COLLATE utf8mb4_general_ci='Realisasi Pengeluaran' AND id_komisi =" .
            $id_komisi .
            "";
    } elseif (isset($_SESSION["bidang"])) {
        $sql_penerimaan =
            "SELECT * from v_realisasikomisi WHERE jenis COLLATE utf8mb4_general_ci='Realisasi Penerimaan'  AND id_bidang =" .
            $id_bidang .
            "";
        $sql_pengeluaran =
            "SELECT * from v_realisasikomisi WHERE jenis COLLATE utf8mb4_general_ci='Realisasi Pengeluaran' AND id_bidang =" .
            $id_bidang .
            "";
    }
    ...
    if (!empty($bulan)) {
        if ($bulan == 0) {
            ...
            $sql_penerimaan .=
                " AND tahun = $tahun_aktif AND month(tanggal) = " . $bulan;
            $sql_pengeluaran .=
                " AND tahun = $tahun_aktif AND  month(tanggal) = " . $bulan;
    ...
    $pdf->Cell(
        0,
        10,
        "LAPORAN REALISASI " . strtoupper($bidangKomisi),
        0,
        1,
        "C",
    );
