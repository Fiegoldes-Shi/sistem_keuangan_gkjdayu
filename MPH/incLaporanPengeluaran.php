...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php _myHeader("document", "Laporan Pengeluaran ", "Laporan "); ?>
        </div>
    </div>
    ...
    <div class="second section filter-section" style="display: flex; justify-content: space-between; align-items: center; width: 100%; color:#003153; font-weight:500; padding: 20px; margin-bottom: 20px; box-sizing: border-box; flex-wrap: wrap; gap: 15px;">
        ...
        <div style="display: flex; justify-content: flex-end; align-items: center; gap: 10px; flex-wrap: wrap; flex: 1;">
            <a href="../cetak/xlxCetakPengeluaran.php" target="" style="background-color:#2e8b57; color:white; padding: 8px 15px; border-radius:4px; text-decoration: none; white-space: nowrap; font-weight: bold;">Cetak Excel</a>
            <a href="../cetak/pdfCetakPengeluaran.php" target="_new" style="background-color:#dc143c; color:white; padding: 8px 15px; border-radius:4px; text-decoration: none; white-space: nowrap; font-weight: bold;">Cetak PDF</a>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        foreach ($groupedData as $tanggal => $tanggalData) {
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td class="text-start" style=" font-weight:bolder"><?= number_format(
                                    $total_pengeluaran,
                                    0,
                                    ",",
                                    ".",
                        ...
                        <?php $all_total = $all_total + $total_pengeluaran;
                        }
                        ?>
                        <tr>
                            <td></td>
                            ...
                            <td></td>
                            <td class="text-start" style="color:#5B90CD; font-weight:bolder"><?= number_format(
                                $all_total,
                                0,
                                ",",
                                ".",
