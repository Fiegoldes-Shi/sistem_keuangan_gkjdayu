...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php _myHeader("Folder", "Rekening Bank", "Data Rekening Bank"); ?>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <?php
            $afield = [
                ["Nama Rekening", "nama_rekening", "", 19],
                ["Nomor Rekening", "no_rekening", "", 111],
                ["Nama Bank", "nama_bank", "", 1],
                ["Jabatan", "jabatan", "", 1],
                ["Deskripsi", "keterangan", "", 17],
            ];

            $caption = ["Data Rekening Bank", "Entri Data Rekening Bank"];
                            ...
                            <tr class=''>
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalDetil(
                                        ...
                                        "",
                                        600,
                                        "Detail Data Rekening Bank#Nama Rekening : " .
                                            $data["nama_rekening"],
                                        "",
                                        $datadetail,
                                        "",
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalUpdate(
                                        ...
                                        "",
                                        "",
                                        "Edit Data Rekening Bank#Nama Rekening : " .
                                            $data["nama_rekening"],
                                        "",
                                        $dataupdate,
                                        "",
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalDelete(
                                        ...
                                        "md",
                                        200,
                                        "Hapus Data Rekening Bank#Nama Rekening : " .
                                            $data["nama_rekening"],
                                        "",
                                        $datadelete,
                                        "13",
