...
if (!empty($_POST["savebtn"])) {
    $datafield = ["nama_bidang", "deskripsi_bidang", "nama_ketuaBidang"];
    $datavalue = [
        "'" . $_POST["nama_bidang"] . "'",
        "'" . $_POST["deskripsi_bidang"] . "'",
        "'" . $_POST["nama_ketuaBidang"] . "'",
    ];
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php _myHeader("Folder", "Bidang", "Data Bidang"); ?>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <?php
            $afield = [
                ["Nama Bidang", "nama_bidang", "", 1],
                ["Koordinator", "nama_ketuaBidang", "", 19],
                ["Deskripsi", "deskripsi_bidang", "", 17],
            ];

            $caption = ["COA", "Entri Data Bidang"];
                            ...
                            <tr class=''>
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalDetil(
                                        ...
                                        "",
                                        600,
                                        "Detail Data Bidang #Data Bidang $cnourut : " .
                                            $data["nama_bidang"],
                                        "",
                                        $datadetail,
                                        "",
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalUpdate(
                                        ...
                                        "",
                                        "",
                                        "Edit Data Bidang #Data Bidang $cnourut : " .
                                            $data["nama_bidang"],
                                        "",
                                        $dataupdate,
                                        "",
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalDelete(
                                        ...
                                        "md",
                                        200,
                                        "Hapus Data Bidang #Data Bidang $cnourut : " .
                                            $data["nama_bidang"],
                                        "",
                                        $datadelete,
                                        "15",
