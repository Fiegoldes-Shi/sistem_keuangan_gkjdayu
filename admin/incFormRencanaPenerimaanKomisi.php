  ...
  <div class="section">
    ...
    <div class="horizontal" style="margin-bottom: 10px;">
      <div class="form-group" style="width: 29%; margin-left: 30px;">
        <label for="item" class="required" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Jenis Penerimaan/Kegiatan</label>
        <input style="width:95%" type="text" id="item" name="item" placeholder="Masukkan Jenis Kegiatan" value="<?= isset(
            $_SESSION["edit_data"],
        )
      ...
      <div class="form-group" style="width:16%; margin-left: -40px;">
        <label for="harga_satuan" class="required" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Harga Satuan (Rp)</label>
        <input style="width:90%" type="number" id="harga_satuan" name="harga_satuan" placeholder="Masukkan Harga Satuan" value="<?= isset(
            $_SESSION["edit_data"],
        )
            ? $_SESSION["edit_data"]["harga_satuan"]
            : "" ?>" oninput="hitungTotal()" min="1" required />
      </div>

      <div class="form-group" style="width:20%; margin-left: -50px;">
        <label for="jumlah" class="required" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Jumlah (Rp)</label>
    ...
    <form action="" method="post" autocomplete="off">
      <table id='data-table' class='table table-condensed table-bordered'>
        ...
        <tbody>
          ...
          $subTotal = 0;
          if (
              isset($_SESSION["temp_data4"]) &&
              count($_SESSION["temp_data4"]) > 0
          ) {
