  ...
  <div class="section">
    <div class="horizontal" style="height:110px">
      <div class="form-group" style="width: 100%; margin-left: 30px;">
        ...
        <input style="width:90%" type="text" id="item" name="item" placeholder="Masukkan Jenis Pengeluaran/Kegiatan" value="<?= isset(
            $_SESSION["edit_data"],
        )
  ...
  <form action="" method="post" autocomplete="off">
    <table id='data-table' class='table table-condensed table-bordered'>
      ...
      <tbody>
        ...
        $total = 0;
        if (
            isset($_SESSION["temp_data3"]) &&
            count($_SESSION["temp_data3"]) > 0
        ) {
