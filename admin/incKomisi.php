...
if (!empty($_POST["savebtn"])) {
    ...
    $datavalue_ang = [
        $_POST["id_bidang"],
        "'" . $_POST["nama_komisi"] . "'",
        "'" . $_POST["deskripsi_komisi"] . "'",
        "'" . $_POST["nama_ketuaKomisi"] . "'",
    ];
...
<div class="row">
    <div class="col-md-12">
        <?php _myHeader("Folder", "Komisi", "Data Komisi"); ?>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            $afield = [
                ...
                ["Nama Ketua", "nama_ketuaKomisi", "", 19],
                ["Deskripsi", "deskripsi_komisi", "", 17],
            ];

            $caption = ["Data Komisi", "Entri Data Komisi"];
    ...
    <div class="row">
        <div class="col-md-12">
            <?php
            $sql =
                "SELECT a.*, b.* FROM komisi a LEFT OUTER JOIN bidang b ON a.id_bidang = b.id_bidang ORDER BY b.id_bidang, a.id_komisi ASC";
            $view = new cView();
                            ...
                            <tr class=''>
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalDetil(
                                        ...
                                        "",
                                        600,
                                        "Detail Data Komisi#Data Komisi $cnourut : " .
                                            $data["nama_komisi"],
                                        "",
                                        $datadetail,
                                        "",
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalUpdate(
                                        ...
                                        "",
                                        "",
                                        "Edit Data Komisi#Data Komisi $cnourut : " .
                                            $data["nama_komisi"],
                                        "",
                                        $dataupdate,
                                        "",
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalDelete(
                                        ...
                                        "md",
                                        200,
                                        "Hapus Data Komisi#Data Komisi $cnourut : " .
                                            $data["nama_komisi"],
                                        "",
                                        $datadelete,
                                        "16",
