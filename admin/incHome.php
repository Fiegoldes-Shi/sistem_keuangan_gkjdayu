...
$total_terima = isset($array[0]["jumlah_penerimaan"])
    ? $array[0]["jumlah_penerimaan"]
    : 0;
$total_keluar = isset($array[0]["jumlah_pengeluaran"])
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php _myHeader("home", "Beranda", "Beranda"); ?>
        </div>
    </div>

    <h3 style="color:#292c5f">Sistem Keuangan GKJ Dayu</h3>
    <h5 style="color:#8B8ABB">Selamat Datang, <?= $_SESSION["nama"] ?> !</h5>
        ...
        <div class="col-md-4 " style="width:28%; background-color: #E5F7FF; border-radius: 15px;">
            <div class="row">
                <div class="col-md-9 d-flex flex-column justify-content-center ps-5 pt-4">
                    ...
                    <h3 style="color:3F3E65; font-weight: 700;">Rp. <?= number_format(
                        $saldo_akhir,
                        0,
                        ",",
                        ".",
            ...
            <div class="row">
                <h5 style="color:8FA9C8; font-weight: 600; padding-left:50px;">Saldo Awal Tahun : <span style="color:557AA6;">Rp. <?= number_format(
                    $saldo_awal,
                    0,
                    ",",
                    ".",
