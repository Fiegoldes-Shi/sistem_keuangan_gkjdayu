...
if (!empty($_POST["editbtn"])) {
    $linkurl = "";
    $datafield = ["nama_anggaran", "id_akun", "jumlah"];
    $datavalue = [
        "'" . $_POST["nama_anggaran"] . "'",
        $_POST["id_akun"],
        $_POST["jumlah"],
    ...
    <div class="row">
        <div class="col-md-12">
            <?php _myHeader(
                ...
                "Data Rencana Pengeluaran Gereja",
            ); ?>
        </div>
    </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalDetil(
                                        ...
                                        "lg",
                                        600,
                                        "Detail Data Rencana Pengeluaran Gereja#Data Rencana $cnourut : " .
                                            $data["nama_anggaran"],
                                        "",
                                        $datadetail,
                                        "",
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalUpdate(
                                        ...
                                        "lg",
                                        "",
                                        "Edit Data Rencana Pengeluaran Gereja#Data Rencana $cnourut : " .
                                            $data["nama_anggaran"],
                                        "",
                                        $dataupdate,
                                        "",
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalDelete(
                                        ...
                                        "md",
                                        200,
                                        "Hapus Data Rencana Pengeluaran Gereja#Data Rencana $cnourut : " .
                                            $data["nama_anggaran"],
                                        "",
                                        $datadelete,
                                        "22",
