...
if (!empty($_POST["editbtn"])) {
    ...
    $datafield = ["id_fiskal", "id_akun", "jumlah_penerimaan"];
    $datavalue = [$id_fiskal, $_POST["id_akun"], $_POST["jumlah_penerimaan"]];
...
$pos = array_search("admin", $segments); // deprecated
...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php _myHeader(
                "newspaper",
                "Rencana Penerimaan Gereja",
                "Data Rencana Penerimaan Gereja",
            ); ?>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            $sql .=
                "LEFT JOIN akun b ON a.id_akun = b.id_akun  LEFT JOIN fiskal e ON a.id_fiskal = e.id_fiskal LEFT JOIN user u ON a.id_user = u.id_user ";
            ...
            <div id="" class='table-responsive'>
                <table id='example' class='table table-condensed w-100'>
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalDetil(
                                        ...
                                        "lg",
                                        600,
                                        "Detail Data Rencana Penerimaan Gereja#Data Rencana $cnourut : " .
                                            $data["nama_akun"],
                                        "",
                                        $datadetail,
                                        "",
                                ...
                                <td class="text-center">
                                    ...
                                    $dataupdate = [
                                        ...
                                        [
                                            ...
                                            $data["id_akun"],
                                            5,
                                            "select id_akun field1, nama_akun field2 from akun where status_input = 1 AND jenis_debitKredit = 'Kredit' ORDER BY kode_akun ASC",
                                        ],
                                        [
                                            "Jumlah Rencana Penerimaan",
                                            "jumlah_penerimaan",
                                    ...
                                    _CreateWindowModalUpdate(
                                        ...
                                        "",
                                        "",
                                        "Edit Data Rencana Penerimaan Gereja#Data Rencana $cnourut : " .
                                            $data["nama_akun"],
                                        "",
                                        $dataupdate,
                                        "",
                                ...
                                <td class="text-center">
                                    ...
                                    _CreateWindowModalDelete(
                                        ...
                                        "md",
                                        200,
                                        "Hapus Data Rencana Penerimaan Gereja#Data Rencana $cnourut : " .
                                            $data["nama_akun"],
                                        "",
                                        $datadelete,
                                        "221",
                        ...
                        <?php $total = $total + $data["jumlah_penerimaan"];
                        }
                        ?>
                    </tbody>
                    <tr>
