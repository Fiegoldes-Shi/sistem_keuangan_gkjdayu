...
if (!empty($_POST["editbtn"])) {
    $id_komisi =
        isset($_POST["id_komisi"]) && $_POST["id_komisi"] !== ""
            ? $_POST["id_komisi"]
            : "NULL";
    $linkurl = "";
    $datafield = [
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            $sql .=
                "WHERE a.id_fiskal = " .
                $id_fiskal .
                " ORDER BY b.id_bidang, c.id_komisi, a.id_program ASC";
                        ...
                        foreach ($groupedData as $bidang => $bidangList) {
                            ...
                            foreach ($bidangList as $komisi => $komisiList) { ?>
                                ...
                                <tr style="font-weight: bold;">
                                    ...
                                    <td style="background-color: #f2f3f4;" width='10%' class="text-left"><?= $firstBidangRow
                                        ? $bidang
                                        : "" ?></td>
                                ...
                                foreach ($komisiList as $data) {
                                    ...
                                    <tr class=''>
                                        ...
                                        <td><?= date(
                                            "d-m-Y",
                                            strtotime($data["tgl_mulai"]),
                                        ) ?></td>
                                        <td><?= date(
                                            "d-m-Y",
                                            strtotime($data["tgl_selesai"]),
                                        ) ?></td>
                                        <td><?= $data[
                                            "penanggung_jawab"
                                        ] ?></td>
                                        <td class="text-center">
                                            ...
                                            $datadetail = [
                                                ...
                                                [
                                                    ...
                                                    "",
                                                    5,
                                                    "select id_unit field1, nama_bidang field2 from unit",
                                                ],
                                                [
                                                    "Komisi",
                                                    ":",
                                                    !empty($data["nama_komisi"])
                                                        ? $data["nama_komisi"]
                                                        : "-",
                                                    "",
                                                    5,
                                            ...
                                            _CreateWindowModalDetil(
                                                ...
                                                "lg",
                                                600,
                                                "Detail Data Program#Data Program $cnourut : " .
                                                    $data["nama_program"],
                                                "",
                                                $datadetail,
                                                "",
                                        ...
                                        <td class="text-center">
                                            ...
                                            _CreateWindowModalUpdate(
                                                ...
                                                "",
                                                "",
                                                "Edit Data Program#Data Program $cnourut : " .
                                                    $data["nama_program"],
                                                "",
                                                $dataupdate,
                                                "",
                                        ...
                                        <td class="text-center">
                                            ...
                                            _CreateWindowModalDelete(
                                                ...
                                                "md",
                                                200,
                                                "Hapus Data Program#Data Program $cnourut : " .
                                                    $data["nama_program"],
                                                "",
                                                $datadelete,
                                                "",
