...
<div class="container-fluid">
  ...
  <div class="section">
    ...
    <div class="form-group" style="width: 29%; margin-left: 30px;">
        ...
        <input style="width:90%" type="text" id="item" name="item" placeholder="Masukkan Jenis Kegiatan" value="<?= isset(
            $_SESSION["edit_data"],
        )
      ...
      <div class="form-group" style="width:14%; margin-left: -50px;">
        ...
        <input style="width:85%" type="text" id="volume" name="volume" placeholder="Masukkan Volume" value="<?= isset(
            $_SESSION["edit_data"],
        )
  ...
  <div class="section">
    <div class="horizontal filter-horizontal" style="display: flex; align-items: center; justify-content: flex-start; gap: 15px; flex-wrap: wrap;">
      <div class="form-group" style="width:20%; margin-left: 30px;">
        ...
        <input style="width:85%" type="number" id="dana_gereja" name="dana_gereja" placeholder="Masukkan Jumlah" value="<?= isset(
            $_SESSION["edit_data"],
        )
    ...
    <form action="" method="post" autocomplete="off">
      <table id='data-table' class='table table-condensed table-bordered'>
        ...
        <tbody>
          ...
          $subTotal = 0;
          if (
              isset($_SESSION["temp_data5"]) &&
              count($_SESSION["temp_data5"]) > 0
          ) {
