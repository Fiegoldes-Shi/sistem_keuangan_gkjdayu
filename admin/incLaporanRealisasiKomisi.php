...
<div class="container-fluid">
            ...
            <div class="horizontal filter-horizontal" style="display: flex; align-items: center; justify-content: flex-start; gap: 15px; flex-wrap: wrap;">
                ...
                <div class="form-group1" style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <select class="form-select" style="width: 350px; margin: 0; padding: 6px 12px; height: 38px;" name="komisi" id="komisi">
                        ...
                        <?php
                        $idbidang = isset($_SESSION["bidang_" . $link]) ? $_SESSION["bidang_" . $link] : null;
    ...
    <div class="second section filter-section" style="display: flex; justify-content: space-between; align-items: center; width: 100%; color:#003153; font-weight:500; padding: 20px; margin-bottom: 20px; box-sizing: border-box; flex-wrap: wrap; gap: 15px;">
        <div>
            <div>
                ...
                if (isset($_POST["filter"]) && $_POST["filter"] == "bulan") {
                    unset($_SESSION["tahun"]); ?>
                    <label for="tb_bulan" style="white-space: nowrap; font-weight: bold; margin: 0; line-height: 1;">Pilih Bulan : </label> &nbsp;
        ...
        <div style="display: flex; justify-content: flex-end; width:auto; gap: 10px; flex: 1;">
            <a href="../cetak/xlxCetakRealisasiKomisi.php" target="" style="background-color:#2e8b57; color:white; padding: 8px 15px; border-radius:4px; text-decoration: none; white-space: nowrap; font-weight: bold;">Cetak Excel</a>
            <a href="../cetak/pdfCetakRealisasiKomisi.php" target="_new" style="background-color:#dc143c; color:white; padding: 8px 15px; border-radius:4px; text-decoration: none; white-space: nowrap; font-weight: bold;">Cetak PDF</a>
        </div>
    </div>
    <br>
        ...
        <div class="col-md-12">
            <?php if (
                ...
                if (isset($_SESSION["komisi_" . $link])) {
                    $sql =
                        "SELECT * from v_realisasikomisi WHERE id_fiskal = $id_fiskal AND id_komisi =" .
                        $_POST["komisi"] .
                        "";
                    if (
                        isset($_POST["filter"]) &&
                    ...
                    if (
                        ...
                        if ($_POST["tb_tahun"] == 0) {
                            ...
                            $sql =
                                "SELECT * from v_realisasikomisi WHERE id_komisi =" .
                                $_POST["komisi"];
                    ...
                    $sql =
                        "SELECT * from v_realisasikomisi WHERE id_fiskal = $id_fiskal AND id_bidang =" .
                        $_POST["bidang"] .
                        "";
                    if (
                        isset($_POST["filter"]) &&
                    ...
                    if (
                        ...
                        if ($_POST["tb_tahun"] == 0) {
                            ...
                            $sql =
                                "SELECT * from v_realisasikomisi WHERE id_bidang =" .
                                $_POST["bidang"];
                            $sql .= " AND tahun = " . $_POST["tb_tahun"];
                        }
                    }
