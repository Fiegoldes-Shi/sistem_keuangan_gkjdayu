...
if (isset($_POST["save"])) {
    $inputData = [
        ...
        "komisi" => intval($_POST["komisi"]) ?? null,
...
if (isset($_POST["submit_all"])) {
    if (
        isset($_SESSION["temp_data11"]) &&
        count($_SESSION["temp_data11"]) > 0
    ) {
        $total_jumlah = 0;
        $total_sumberDana = 0;
...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <?php _myHeader("newspaper", "Penerimaan Komisi", "Entri Data"); ?>
    </div>
  </div>
  <br>
  <div class="section">
  ...
  <div class="section">
    <div class="horizontal filter-horizontal" style="display: flex; align-items: center; justify-content: flex-start; gap: 15px; flex-wrap: wrap;">
          ...
          if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  if (
                      ...
                      isset($_SESSION["edit_data"]) &&
                      (($_SESSION["edit_data"]["program"] === null &&
                          $row["id_program"] === null) ||
                          $_SESSION["edit_data"]["program"] ==
                              $row["id_program"])
                  ) {
                      $selected = "selected";
                  }
      ...
      <div class="form-group" style="width:100%; margin-left: 30px;">
        <label for="tanggalPenerimaan" class="required" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Tanggal Penerimaan</label>
        <input style="width:90%" type="date" class="form-control" name="tanggal_terima" id="" min="<?= $tahun_aktif -
            1 ?>-01-01" max="<?= $tahun_aktif ?>-12-31" value="<?= isset(
    $_SESSION["edit_data"],
)
    ? $_SESSION["edit_data"]["tanggal_terima"]
    : "" ?>"
          required />
  ...
  <div class="section">
    <div class="horizontal" style="height:90px">
      <div class="form-group" style="width: 30%; margin-left: 30px;">
        <label for="jenis" class="required" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Jenis Penerimaan/Kegiatan</label>
        <input style="width:95%;" type="text" id="jenis_terima" name="jenis_terima" placeholder="Masukkan Jenis Penerimaan/Kegiatan"
          value="<?= isset($_SESSION["edit_data"])
              ? $_SESSION["edit_data"]["jenis_terima"]
              : "" ?>"
          required />
        <?php  ?>
      </div>
      ...
      <div class="form-group" style="width:14%; margin-left: -60px;">
        ...
        <input style="width:79%" type="text" id="satuan" name="satuan" placeholder="Masukkan Satuan" value="<?= isset(
            $_SESSION["edit_data"],
        )
      ...
      <div class="form-group" style="width:18%; margin-left: -60px;">
        ...
        <input style="width:79%" type="number" id="harga" name="harga" placeholder="Masukkan Harga Satuan" value="<?= isset(
            $_SESSION["edit_data"],
        )
      ...
      <div class="form-group" style="width:19%; margin-left: -70px;">
        <label for="jumlah" class="required" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Jumlah</label>
        <input style="width:90%; background-color: #f2f3f4;" type="number" id="jumlah" name="jumlah" placeholder="Jumlah" value="<?= isset(
            $_SESSION["edit_data"],
        )
  ...
  <div class="section">
    <div class="horizontal filter-horizontal" style="display: flex; align-items: center; justify-content: flex-start; gap: 15px; flex-wrap: wrap;">
      <div class="form-group" style="width:20%; margin-left: 30px;">
        <label for="sumber_dana" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Dana Gereja</label>
        <input style="width:90%" type="number" id="dana_gereja" name="dana_gereja" placeholder="Masukkan Jumlah" value="<?= isset(
            $_SESSION["edit_data"],
        )
      ...
      <div class="form-group" style="width:20%;">
        <label for="sumber_dana" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Dana Swadaya</label>
        <input style="width:90%" type="number" id="dana_swadaya" name="dana_swadaya" placeholder="Masukkan Jumlah" value="<?= isset(
            $_SESSION["edit_data"],
        )
