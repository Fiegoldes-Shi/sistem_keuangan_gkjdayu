...
if (isset($_POST["submit_all"])) {
    if (isset($_SESSION["temp_data2"]) && count($_SESSION["temp_data2"]) > 0) {
        foreach ($_SESSION["temp_data2"] as $data) {
            ...
            $datavalue = [$id_user, $id_fiskal, $data["akun"], $data["jumlah"]];
      ...
      <div class="horizontal" style="height: 80px;">
        <div class="form-group" style="width:100%; margin-left: 30px;">
          ...
          <select style="width:90%" id="akun" name="akun" required>
            ...
            <?php
            $sql =
                "SELECT id_akun, nama_akun FROM akun where jenis_debitKredit = 'Kredit' AND status_input = 1";
        ...
        <div class="form-group" style="width:100%">
          <label for="jumlah" class="required" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Jumlah Rencana Penerimaan (Rp)</label>
    ...
    <form action="" method="post" autocomplete="off">
      <table id='data-table' class='table table-condensed table-bordered'>
        ...
        <tbody>
          ...
          $total = 0;
          if (
              isset($_SESSION["temp_data2"]) &&
              count($_SESSION["temp_data2"]) > 0
          ) {
