...
if (!empty($_POST["editbtn"])) {
    $id_akun =
        isset($_POST["id_akun"]) && $_POST["id_akun"] !== "-"
            ? $_POST["id_akun"]
            : null;
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                $dataupdate = [
                                                    ...
                                                    [
                                                        ...
                                                        $data["id_program"],
                                                        5,
                                                        "select id_program field1, nama_program field2 from program where id_fiskal = $id_fiskal AND id_bidang = " .
                                                        $data["bidang"] .
                                                        " ORDER BY id_program",
                                                    ],
                                                    [
                                                ...
                                                _CreateWindowModalUpdate(
                                                    ...
                                                    "",
                                                    "",
                                                    "Edit Data Rencana Pengeluaran Komisi#Data Rencana $cnourut : " .
                                                        $data["item"],
                                                    "",
                                                    $dataupdate,
                                                    "",
                                            ...
                                            <td class="text-center">
                                                ...
                                                _CreateWindowModalDelete(
                                                    ...
                                                    "md",
                                                    200,
                                                    "Hapus Data Rencana Pengeluaran Komisi#Data Rencana $cnourut : " .
                                                        $data["item"],
                                                    "",
                                                    $datadelete,
                                                    "23",
