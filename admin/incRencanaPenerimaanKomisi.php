...
if (!empty($_POST["editbtn"])) {
    $id_program =
        ($_POST["id_program"] ?? "-") !== "-" && $_POST["id_program"] !== ""
            ? $_POST["id_program"]
            : 0;
    $id_komisi =
        ($_POST["id_komisi"] ?? "-") !== "-" && $_POST["id_komisi"] !== ""
            ? $_POST["id_komisi"]
            : "NULL";
                        ...
                        foreach ($groupedData as $bidang => $bidangList) {
                            ...
                            <?php foreach (
                                ...
                                foreach (
                                    ...
                                    <tr style="font-weight: bold;">
                                        <td></td>
                                        <td style="background-color:#f2f3f4; color: #1a2e62" width="20%"><?= !empty(
                                            $program
                                        )
                                            ? "Program : " . $program
                                            : "" ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                $dataupdate = [
                                                    ...
                                                    [
                                                        ...
                                                        $data["program"],
                                                        51,
                                                        "SELECT program.id_program AS field1, 
                                                ...
                                                _CreateWindowModalUpdate(
                                                    ...
                                                    "md",
                                                    "",
                                                    "Edit Data Rencana Penerimaan Komisi#Data Rencana $cnourut : " .
                                                        $data[
                                                            "jenis_penerimaan"
                                                        ],
                                                    "",
                                            ...
                                            <td class="text-center">
                                                ...
                                                _CreateWindowModalDelete(
                                                    ...
                                                    "md",
                                                    200,
                                                    "Hapus Data Rencana Penerimaan Komisi#Data Rencana $cnourut : " .
                                                        $data[
                                                            "jenis_penerimaan"
                                                        ],
                                                    "",
