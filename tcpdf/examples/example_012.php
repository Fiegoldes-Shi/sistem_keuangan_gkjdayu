...
$pdf->Ellipse(175, 105, 15, 7.5, 45, 90, 180, "", $style6);
...
$pdf->Polygon([120, 135, 140, 135, 150, 155, 110, 155], "D", [
    $style6,
    0,
    $style7,
    $style6,
...
$pdf->Polygon(
    [160, 135, 190, 155, 170, 155, 200, 160, 160, 165],
    "DF",
    ["all" => $style6],
    [220, 220, 220],
);
...
$pdf->PolyLine(
    [80, 165, 90, 160, 100, 165, 110, 160, 120, 165, 130, 160, 140, 165],
    "D",
    [],
    [],
);
...
$pdf->RegularPolygon(55, 190, 10, 6, 45, false, "DF", [
    $style6,
    0,
    $style7,
    0,
...
$pdf->RoundedRect(140, 255, 40, 30, 8.0, "0101", "DF", $style6, [
    200,
    200,
    200,
]);
