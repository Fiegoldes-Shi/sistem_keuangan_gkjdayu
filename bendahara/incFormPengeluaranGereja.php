...
if (isset($_POST["submit_all"])) {
    ...
    if (
        isset($_SESSION["temp_data16"]) &&
        count($_SESSION["temp_data16"]) > 0
    ) {
...
?>
      ...
      <div class="horizontal" style="height:80px">
        <div class="form-group" style="width: 100%; margin-left: 30px;">
          <label for="jenis_pengeluaran" class="required" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Keterangan Pengeluaran</label>
          <input style="width:90%" type="text" id="jenis_pengeluaran" name="jenis_pengeluaran" placeholder="Masukkan Keterangan Pengeluaran" value="<?= isset(
              $_SESSION["edit_data"],
          )
              ? $_SESSION["edit_data"]["jenis_pengeluaran"]
              : "" ?>" required />
        </div>

        <div class="form-group" style="width:100%">
          <label for="total" class="required" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Jumlah Pengeluaran(Rp)</label>
          <input style="width:90%;" type="number" id="total" name="total" placeholder="Total" value="<?= isset(
              $_SESSION["edit_data"],
          )
      ...
      <div class="horizontal" style="height:70px">
        <div class="form-group" style="width:50%; margin-left: 30px;">
          <label for="bukti_pengeluaran" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Bukti Pengeluaran</label>
        ...
        <tbody>
          ...
          if (
              ...
              <tr class=''>
                ...
                <td><?= !empty($data["bukti_pengeluaran"])
                    ? $data["bukti_pengeluaran"]
                    : "-" ?></td>
                <td>
