...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php _myHeader(
                "document",
                "Rekapitulasi Rencana dan Realisasi Pengeluaran Gereja",
                "Laporan ",
            ); ?>
        </div>
    </div>
    ...
    <div class="second section filter-section" style="display: flex; justify-content: space-between; align-items: center; width: 100%; color:#003153; font-weight:500; padding: 20px; margin-bottom: 20px; box-sizing: border-box; flex-wrap: wrap; gap: 15px;">
        ...
        <div style="display: flex; justify-content: flex-end; align-items: center; gap: 10px; flex-wrap: wrap; flex: 1;">
            <a href="../cetak/xlxCetakPengeluaranAkun.php" target="" style="background-color:#2e8b57; color:white; padding: 8px 15px; border-radius:4px; text-decoration: none; white-space: nowrap; font-weight: bold;">Cetak Excel</a>
            <a href="../cetak/pdfCetakPengeluaranAkun.php" target="_new" style="background-color:#dc143c; color:white; padding: 8px 15px; border-radius:4px; text-decoration: none; white-space: nowrap; font-weight: bold;">Cetak PDF</a>
        </div>
    </div>
            ...
            <div id="" class='table-responsive'>
                <table id="" class="table table-bordered table-condensed w-100">
                    ...
                    <tbody>
                        ...
                        foreach ($array as $data) {
                            ...
                            <tr class=''>
                                ...
                                <td class="text-end"><?= number_format(
                                    $data["dana_gereja_rencana"],
                                    0,
                                    ",",
                                    ".",
                                ) ?></td>
                                <td class="text-end"><?= number_format(
                                    $data["dana_swadaya_rencana"],
                                    0,
                                    ",",
                                    ".",
                                ) ?></td>
                        ...
                        $dana_gereja_realisasi +=
                            $data["dana_gereja_realisasi"];
                        $dana_swadaya_realisasi +=
                            $data["dana_swadaya_realisasi"];
                        $subtotal_realisasi +=
                            $data["dana_gereja_realisasi"] +
                            $data["dana_swadaya_realisasi"];
