				...
				<div class="card-Kas">
					<div class="position-relative text-center mb-3">
						<h5 id="grafikTitle" class="m-0">
							Grafik Kas Gereja
							<?php echo !empty($bulan_text)
           ? $bulan_text . " " . $tahun_aktif
           : "Bulan tidak valid " . $tahun_aktif; ?>
						</h5>
					...
					<div class="text-center mb-3">
						<label for="monthDropdown" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Pilih Bulan:</label>
	...
	<div class="row justify-content-end" style="margin: 20px;">
		...
		<div class="col-md-5">
          ...
          : $tahun_aktif; ?>
				...
				<!-- Filter Bulan -->
				<div class="text-center mb-3">
					<label for="bulanSelectKomisi" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Pilih Bulan:</label>
					<select id="bulanSelectKomisi" class="form-control d-inline-block" style="width: auto;">
						<option value="">Semua Bulan</option>
						<?php foreach ($bulan_nama as $bulan_num => $bulan_label): ?>
							<option value="<?= $bulan_num ?>" <?= $bulan_aktif == $bulan_num
    ? "selected"
    : "" ?>>
								<?= $bulan_label ?>
							</option>
		...
		<div class="col-md-7">
			<div style="border: 1px solid rgba(0, 0, 0, 0.66); padding: 16px; border-radius: 12px;">
				...
				<!-- Filter Bulan -->
				<div class="text-center mb-3">
					<label for="bulanFilterKomisi" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Pilih Bulan:</label>
