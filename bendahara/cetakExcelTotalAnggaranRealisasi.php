...
foreach ($data_anggaran as $bidang => $programs) {
    ...
    echo "<tr><td colspan='7' style='font-weight:bold; text-align:left;'>Bidang: " . esc($bidang) . "</td></tr>";
    ...
    echo "<tr style='font-weight:bold;'>
        <td colspan='4'>Total Anggaran Bidang " . esc($bidang) . "</td>
...
foreach ($data_pengeluaran as $bidang => $programs) {
    ...
    echo "<tr><td colspan='8' style='font-weight:bold; text-align:left;'>Bidang: " . esc($bidang) . "</td></tr>";
    ...
    echo "<tr style='font-weight:bold;'>
        <td colspan='5'>Total Pengeluaran Bidang " . esc($bidang) . "</td>
        <td>" . formatRupiah($totalBidangG) . "</td>
        <td>" . formatRupiah($totalBidangS) . "</td>
        <td>" . formatRupiah($totalBidangT) . "</td>
    </tr>";
