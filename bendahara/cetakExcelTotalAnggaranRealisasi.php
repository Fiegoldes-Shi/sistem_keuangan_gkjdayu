...
$tahun = isset($_GET["tahun_aktif"])
    ? intval($_GET["tahun_aktif"])
    : $_SESSION["tahun_aktif"] ?? date("Y");
$bulan =
    isset($_GET["bulan"]) && is_numeric($_GET["bulan"])
        ? intval($_GET["bulan"])
        : null;
$nama_bulan = [
    1 => "Januari",
...
$namaFile =
    "laporanRencanaRealisasiPerBidang_{$tahun}" .
    ($bulan ? "_{$nama_bulan[$bulan]}" : "_Januari-Desember") .
    ".xls";
...
{
    return is_null($angka)
        ? "Data tidak tersedia"
        : "Rp " . number_format(round($angka), 0, ",", ".");
}
...
$q_pengeluaran .=
    " ORDER BY b.nama_bidang, p.nama_program, pg.tanggal_pengeluaran";
...
echo "<tr><th colspan='7'>TOTAL ANGGARAN - Periode {$tahun}" .
    ($bulan ? " Bulan {$nama_bulan[$bulan]}" : " Januari–Desember") .
    "</th></tr>";
echo "<tr>
    <th>Akun</th>
    <th>Item</th>
...
foreach ($data_anggaran as $bidang => $programs) {
    ...
    echo "<tr><td colspan='7' style='font-weight:bold; text-align:left;'>Bidang: " .
    ...
    foreach ($programs as $program => $rows) {
        echo "<tr><td colspan='7' style='font-weight:bold; text-align:left;'>Program: " .
        ...
        foreach ($rows as $r) {
            echo "<tr>
                ...
                "</td>
                <td>" .
                formatRupiah($r["dana_gereja"]) .
                "</td>
                <td>" .
                formatRupiah($r["dana_swadaya"]) .
                "</td>
                <td>" .
                formatRupiah($r["total_anggaran"]) .
                "</td>
            </tr>";
        ...
        echo "<tr style='font-weight:bold;'>
            <td colspan='4'>Total Keseluruhan Program " .
            htmlspecialchars($program) .
            "</td>
            <td>" .
            formatRupiah($totalProgramG) .
            "</td>
            <td>" .
            formatRupiah($totalProgramS) .
            "</td>
            <td>" .
            formatRupiah($totalProgramT) .
            "</td>
        </tr>";
    ...
    echo "<tr style='font-weight:bold;'>
        <td colspan='4'>Total Anggaran Bidang " .
        htmlspecialchars($bidang) .
        "</td>
        <td>" .
        formatRupiah($totalBidangG) .
        "</td>
        <td>" .
        formatRupiah($totalBidangS) .
        "</td>
        <td>" .
        formatRupiah($totalBidangT) .
        "</td>
    </tr>";
}
echo "</table><br><br>";
...
echo "<table border='1' cellpadding='5' cellspacing='0' style='border-collapse: collapse; width:100%;'>";
echo "<tr><th colspan='8'>TOTAL PENGELUARAN - Periode {$tahun}" .
    ($bulan ? " Bulan {$nama_bulan[$bulan]}" : " Januari–Desember") .
    "</th></tr>";
echo "<tr>
    <th>Tanggal</th>
...
foreach ($data_pengeluaran as $bidang => $programs) {
    ...
    echo "<tr><td colspan='8' style='font-weight:bold; text-align:left;'>Bidang: " .
        htmlspecialchars($bidang) .
        "</td></tr>";
    ...
    foreach ($programs as $program => $rows) {
        echo "<tr><td colspan='8' style='font-weight:bold; text-align:left;'>Program: " .
            htmlspecialchars($program) .
            "</td></tr>";
        ...
        echo "<tr style='font-weight:bold;'>
            <td colspan='5'>Total Keseluruhan Program " .
            htmlspecialchars($program) .
            "</td>
            <td>" .
            formatRupiah($totalProgramG) .
    ...
    echo "<tr style='font-weight:bold;'>
        <td colspan='5'>Total Pengeluaran Bidang " .
        htmlspecialchars($bidang) .
        "</td>
        <td>" .
        formatRupiah($totalBidangG) .
