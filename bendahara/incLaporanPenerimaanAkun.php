...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php _myHeader(
                "document",
                "Rekapitulasi Rencana dan Realisasi Penerimaan Gereja",
                "Laporan ",
            ); ?>
        </div>
    </div>
    ...
    <div class="second section filter-section" style="display: flex; justify-content: space-between; align-items: center; width: 100%; color:#003153; font-weight:500; padding: 20px; margin-bottom: 20px; box-sizing: border-box; flex-wrap: wrap; gap: 15px;">
        <div class="" style="width:60%">
            ...
            <div style="display: flex; align-items: center;">
                ...
                if (isset($_POST["filter"]) && $_POST["filter"] == "bulan") {
                    ...
                    ?>
                    <label for="tb_bulan" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Pilih Bulan : </label> &nbsp;
        ...
        <div style="display: flex; justify-content: flex-end; align-items: center; gap: 10px; flex-wrap: wrap; flex: 1;">
            <a href="../cetak/xlxCetakPenerimaanAkun.php" target="" style="background-color:#2e8b57; color:white; padding: 8px 15px; border-radius:4px; text-decoration: none; white-space: nowrap; font-weight: bold;">Cetak Excel</a>
            <a href="../cetak/pdfCetakPenerimaanAkun.php" target="_new" style="background-color:#dc143c; color:white; padding: 8px 15px; border-radius:4px; text-decoration: none; white-space: nowrap; font-weight: bold;">Cetak PDF</a>
        </div>
    </div>
    <br>
          ...
          FROM (( fiskal JOIN akun ON (1 = 1))
            ...
            if (isset($_POST["filter"]) && $_POST["filter"] == "bulan") {
                if ($_POST["tb_bulan"] == 0) {
                    ...
                    $sql =
                        "SELECT a.nama_akun AS nama_akun, 0 AS jumlah_rencana, COALESCE(SUM(p.jumlah_penerimaan), 0) AS jumlah_realisasi ";
                    $sql .= "FROM akun a ";
                    ...
                    $sql .=
                        " WHERE a.jenis_debitKredit = 'Kredit' AND a.statusAktif = 1 GROUP BY a.id_akun";
                }
                ...
                if ($_POST["tb_tahun"] == 0) {
                    ...
                    $sql .=
                        " WHERE akun.jenis_debitKredit = 'Kredit' AND akun.statusAktif = 1 AND tahun = " .
                        $_POST["tb_tahun"] .
                        " 
                            GROUP BY fiskal.tahun, akun.id_akun ORDER BY fiskal.tahun, akun.id_akun";
                }
