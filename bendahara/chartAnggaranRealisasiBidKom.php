...
if (!$countStmt) {
    echo json_encode([
        "error" => "Prepare count statement gagal: " . $conn->error,
    ]);
    exit();
}
...
echo json_encode([
    "data" => array_map(function ($row) {
        return [
            ...
            "dana_swadaya_pengeluaran" =>
                (float) $row["dana_swadaya_pengeluaran"],
            "dana_gereja_pengeluaran" =>
                (float) $row["dana_gereja_pengeluaran"],
