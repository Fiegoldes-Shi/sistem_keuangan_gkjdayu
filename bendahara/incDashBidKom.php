                    ...
                    <div class="horizontal" style="height: 80px;">
                        <div class="form-group" style="width:100%; margin-left: 30px;">
                            ...
                            <select style="width: 350px; margin: 0; padding: 6px 12px; height: 38px;" id="bidang" name="bidang" required>
                                ...
                                <?php
                                $sql =
                                    "SELECT id_bidang, nama_bidang FROM bidang";
                        ...
                        <div class="form-group" style="width:100%">
                            ...
                            <select style="width: 350px; margin: 0; padding: 6px 12px; height: 38px;" name="komisi" id="komisi" required>
                                <option value="">-- Pilih Komisi --</option>
                            </select>
                        </div>
                        <div class="form-group" style="width:50%">
                            <label for="start_month" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Periode Mulai</label>
                        ...
                        <div class="form-group" style="width:50%">
                            <label for="end_month" style="white-space: nowrap; font-weight: bold; margin-bottom: 0;">Periode Akhir</label>
