    ...
    <div class="row">
        <div class="col-md-12">
            ...
            $sql .=
                "WHERE a.id_fiskal = " .
                $id_fiskal .
                "  ORDER BY c.id_bidang, d.id_komisi, tanggal_pencairan ASC, a.id_program ASC";
            ...
            <div class='table-responsive'>
                <table id='example' class='table table-condensed w-100'>
                            ...
                            $firstBidangRow = true; ?>
                                <?php foreach (
                                    ...
                                    <tr style="font-weight: bold;">
                                        ...
                                        <td style="background-color: #f2f3f4;" width='17%'><?= $firstBidangRow
                                            ? $bidang
                                            : "" ?></td>
                                    ...
                                    foreach ($komisiList as $data) {
                                        ...
                                        <tr class=''>
                                            ...
                                            <td class="text-end"><?= number_format(
                                                $data["jumlah_pencairan"],
                                                0,
                                                ",",
                                                ".",
                                            ) ?></td>
                                            <td></td>
                                            <td class="text-center"><?= !empty(
                                                $data["nama_bank"]
                                            ) && !empty($data["nama_rekening"])
                                                ? $data["nama_bank"] .
                                                    " - " .
                                                    $data["nama_rekening"]
                                                : "Cash" ?></td>
                                            <td class="text-center">
                                                <?php
                                                $buktiTransferFile = htmlspecialchars(
                                                    $data["bukti_transfer"] ??
                                                        "",
                                                    ENT_QUOTES,
                                                    "UTF-8",
                                                ...
                                                $datadetail = [
                                                    ...
                                                    [
                                                        ...
                                                        ":",
                                                        "<a href='{$protocol}://{$host}{$uploadPath}{$buktiTransferFile}' target='_blank'>{$buktiTransferFile}</a>",
                                                        1,
                                                    ],
                                                    [
                                                        "Dicairkan oleh",
                                                ...
                                                _CreateWindowModalDetil(
                                                    ...
                                                    "lg",
                                                    600,
                                                    "Detail Data Pencairan Dana#Data Pencairan $cnourut",
                                                    "",
                                                    $datadetail,
                                                    "",
                                                    "23",
                                            ...
                                            <td class="text-center">
                                                ...
                                                $dataupdate = [
                                                    ...
                                                    [
                                                        ...
                                                        $data["id_bidang"],
                                                        5,
                                                        "select id_bidang field1, nama_bidang AS field2  from bidang",
                                                    ],
                                                    [
                                                        "Komisi",
                                                        "id_komisi",
                                                        $data["id_komisi"],
                                                        51,
                                                        "select id_komisi field1, nama_komisi AS field2  from komisi",
                                                    ],
                                                    [
                                                        "Akun",
                                                        "id_akun",
                                                        $data["id_akun"],
                                                        5,
                                                        "select id_akun field1, nama_akun AS field2  from akun WHERE jenis_debitKredit = 'Debet' AND status_input = 1 ORDER BY kode_akun ASC",
                                                    ],
                                                    [
                                                        "Program",
                                                        "id_program",
                                                        $data["id_program"],
                                                        51,
                                                        "select id_program field1, nama_program AS field2  from program where id_fiskal = $id_fiskal and id_bidang = " .
                                                        $data["id_bidang"],
                                                    ],
                                                    [
                                                        "Tanggal Pencairan",
                                                    ...
                                                    [
                                                        ...
                                                        $data["id_bank"],
                                                        51,
                                                        "select id_bank field1, CONCAT(nama_bank, ' - ', nama_rekening) AS field2  from bank",
                                                    ],
                                                    [
                                                        "Keterangan",
                                                        "keterangan",
                                                ...
                                                _CreateWindowModalUpdate(
                                                    ...
                                                    "",
                                                    "",
                                                    "Edit Data Pencairan Dana#Data Pencairan " .
                                                        $cnourut,
                                                    "",
                                                    $dataupdate,
                                                    "",
                                            ...
                                            <td class="text-center">
                                                ...
                                                _CreateWindowModalDelete(
                                                    ...
                                                    "md",
                                                    200,
                                                    "Hapus Data Pencairan Dana#Data Pencairan  $cnourut : " .
                                                        $data["nama_program"],
                                                    "",
                                                    $datadelete,
                                                    "25",
                                    ...
                                    <tr>
                                        ...
                                        <td width='6%' class="text-end" style="font-weight: bold;"><?= number_format(
                                            $total,
                                            0,
                                            ",",
                                            ".",
                    ...
                    <tr>
                        ...
                        <td width=''></td>
                        <td width='6%' class="text-end" style="font-weight: bold; color:#5B90CD"><?= number_format(
                            $total_bidang,
                            0,
                            ",",
                            ".",
